...
int main() {
    ...
    objectsNode.addMethod(
        {1, 1000},
        "Greet",
        [](opcua::Session&, const opcua::NodeId&, opcua::Span<const opcua::Variant> input, opcua::Span<opcua::Variant> output) {
    ...
    [&](opcua::Session& session, const opcua::NodeId& methodID, opcua::Span<const opcua::Variant>, opcua::Span<opcua::Variant> output) {
